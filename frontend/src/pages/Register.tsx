...
import { useAuth } from "../context/AuthContext"; // Assuming AuthContext provides loginAuth
  ...
  return (
    <div className="flex h-screen bg-gray-50 items-center justify-center">
      <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
        ...
        <p className="text-center text-gray-500 mb-8">Start monitoring your API endpoints</p>
